    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between py-2">
          <div>
            <h3 className="text-surface-900 dark:text-white font-medium">Message sound</h3>
        ...
        <div className="flex items-center justify-between py-2">
          <div>
            <h3 className="text-surface-900 dark:text-white font-medium">Group notifications</h3>
            <p className="text-sm text-surface-600 dark:text-surface-400 mt-1">
        ...
        <div className="flex items-center justify-between py-2">
          <div>
            <h3 className="text-surface-900 dark:text-white font-medium">In-app preview</h3>
            <p className="text-sm text-surface-600 dark:text-surface-400 mt-1">
